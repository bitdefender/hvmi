...
///
/// @brief  Computes the CRC for a byte array.
///
{
    const BYTE *p = Buffer;
...
///
/// @brief  Computes the CRC for a NULL-terminated utf-8 string.
///
{
    DWORD crc = InitialCrc ^ ~0;
...
///
/// @brief  Computes the CRC for a NULL-terminated wide char string.
///
{
    DWORD crc = InitialCrc ^ ~0;
...
///
/// @brief  Computes the CRC for a NULL-terminated wide char string, but without exceeding a maximum number of
/// characters.
///
{
    DWORD crc = InitialCrc ^ ~0;
...
///
/// @brief  Computes the CRC for a NULL-terminated utf-8 string, but without exceeding a maximum number of characters.
///
{
    DWORD crc = InitialCrc ^ ~0;
